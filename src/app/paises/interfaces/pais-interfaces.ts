...
export class Convert {
    public static toWelcome(json: string): Pais[] {
        return cast(JSON.parse(json), a(r("Welcome")));
    }

    public static welcomeToJson(value: Pais[]): string {
...
const typeMap: any = {
    ...
    "Currencies": o([
        { json: "EUR", js: "EUR", typ: u(undefined, r("Cop")) },
        { json: "COP", js: "COP", typ: u(undefined, r("Cop")) },
    ], false),
    "Cop": o([
